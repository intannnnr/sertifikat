        ...
        <div class="layout-page">
          ...
          >
           ...
           <div class="card mb-4">                 
                ...
                <h5 class="card-header">Data certificate</h5>
                <br>
                  <table class="table">
                  <div class="card-header">
        <i class="fas fa-table me-1"></i>
           <a href="<?= base_url('dashboard/certificate/tambah_certificate');?>" class="btn btn-primary" style="float: right;">
             + tambah 
                    </a>
                    </div>
                     <br>
                    <thead>
                      ...
                      <tbody>
                       <?php
                        ...
                        <td>
                       <a href="<?= base_url('dashboard/certificate/edit_certificate/'. $row->certificate_id);?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                        <a href="<?= base_url('dashboard/certificate/hapus_certificate/'. $row->certificate_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> hapus</a>
                         </td>
                        <tr>  
                          <?php
                          }
