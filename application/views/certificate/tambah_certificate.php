        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">tambah data certificate</h4>
              <div class="row">
                <div class="col-xl">
                <form action="<?= base_url('dashboard/certificate/fungsi_tambah_certificate');?>" method="post"> 
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-control" id="cars" name="participant_name">
                        <option selected="true" disabled="disabled">Choose participant name</option>
                        <?php
