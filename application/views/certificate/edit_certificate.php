        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">edit data certificate</h4>
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">data certificate</h5>
                      <small class="text-muted float-end"></small>
                    </div>
                    <div class="card-body">
                    <form action="<?= base_url('dashboard/certificate/fungsi_edit_certificate');?>" method="post">
                      <form>                      
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">participant name</label>
                          <input type="hidden" class="form-control" id="basic-default-company"name="certificate_id" placeholder="" value="<?= $queryAllcertificate->certificate_id ?>" />
                          </div>
                        <div class="mb-3">
                          <input type="text" class="form-control" id="basic-default-company"name="participant_name" placeholder="" value="<?= $queryAllcertificate->participant_name ?>" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">event name</label>
                          <input type="text" class="form-control" id="basic-default-company"name="event_name" placeholder="" value="<?= $queryAllcertificate->event_name ?>" />
                        </div>
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <input
                              ...
                              class="form-control"
                              placeholder="masukan id kelas" value="<?= $queryAllcertificate->event_date ?>"
                              aria-label="john.doe"
                        ...
                        <div class="mb-3">
                        <label class="form-label" for="basic-default-email">certificate text </label>
                          <div class="input-group input-group-merge">
                            <input
                              type="text"
                              id="basic-default-email"name="certificate_text"
                              class="form-control"
                              placeholder="masukan id" value="<?= $queryAllcertificate->certificate_text ?>"
                              aria-label="john.doe"
                              aria-describedby="basic-default-email2"
                            />
                            <span class="input-group-text" id="basic-default-email2"></span>
