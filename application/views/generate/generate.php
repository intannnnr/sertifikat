    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <i class="fas fa-table me-1"></i>
           <a href="<?= base_url('dashboard/generate/tambah_generate');?>" class="btn btn-primary" style="float: right;">
             + tambah 
                    </a>
                    </div>
                     <br>
                    ...
                    <tbody>
                       <?php
                        ...
                        <td><?= $row->user_id ?></td>
                        <td><?= $row->event_id ?></td>
                        <td><span class="badge rounded-pill bg-label-primary me-1"><?= $row->assigned_at ?></span></td>
                        <td>
                       <!-- <a href="<?= base_url('dashboard/generate/edit_generate/'. $row->assignment_id);?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a> -->
                        <a href="<?= base_url('dashboard/generate/hapus_generate/'. $row->assignment_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> hapus</a>
                        <a href="<?= base_url('dashboard/generate/download/'. $row->assignment_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i>download</a>
                        <tr>  
                          <?php
                          }
                          ?>
