      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">tambah data generate</h4>
              <div class="row">
              
                <div class="col-xl">
                <form action="<?= base_url('dashboard/generate/fungsi_tambah_generate');?>" method="post"> 
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">data generate</h5>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="cars" name="certificate_id">
                        <option selected="true" disabled="disabled">Choose certificate id</option>
                        <?php
        ...
        <div class="form-group">
                      ...
                      <select class="form-control" id="cars" name="user_id">
                        <option selected="true" disabled="disabled">Choose user id</option>
                        <?php
        ...
        <div class="form-group">
                      ...
                      <select class="form-control" id="cars" name="event_id">
                        <option selected="true" disabled="disabled">Choose event id</option>
                        <?php
                          foreach($events as $events){
                        ?>
                        <option value="<?= $events->event_id ?>"><?= $events->event_id ?></option>
                        <?php
                          }
                        ?>
                      </select>
