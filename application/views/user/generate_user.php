      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
                <li class="menu-item">
              <a href="<?= base_url('generate_user'); ?>" class="menu-link">
...
                    </div>
                    ...
                    <tbody>
                       <?php
                        ...
                        <a href="<?= base_url('generate_user/download/'. $row->assignment_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i>download</a>
                        <tr>  
                          <?php
                          }
                          ?>
