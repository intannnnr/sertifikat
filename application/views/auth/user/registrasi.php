        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <form class="user" method="POST" action="<?= base_url('auth/auth_user/registrasi');?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Enter your full_name" />
                  <?= form_error('full_name', '<small class="text-danger p1-3>', '<small'); ?>
                ...
                <div class="mb-3">
                  ...
                  autofocus value="<?=set_value('level'); ?>"/>
                  <?= form_error('level', '<small class="text-danger p1-3>', '<small'); ?>
                </div>
               <br>
              ...
              <p class="text-center">
                ...
                <a href="<?= base_url('auth/auth_user'); ?>">
