        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">tambah data events</h4>
              <div class="row">
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                    <?= form_open_multipart('dashboard/events/fungsi_tambah_events');?>
                      <form>                      
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">event name</label>
                          <input type="text" class="form-control" id="basic-default-company"name="event_name" placeholder="" />
                        </div>
                        <div class="mb-3">
