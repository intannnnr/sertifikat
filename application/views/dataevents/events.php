        ...
        <div class="layout-page">
          ...
          >
           ...
           <div class="card mb-4">                 
                ...
                <h5 class="card-header">Data events</h5>
                <br>
                  <table class="table">
                  <div class="card-header">
        <i class="fas fa-table me-1"></i>
           <a href="<?= base_url('dashboard/events/tambah_events');?>" class="btn btn-primary" style="float: right;">
             + tambah 
                    </a>
                    </div>
                     <br>
                    <thead>
                      ...
                      <tbody>
                       <?php
                        ...
                        <td><?= $row->location ?></td>
                        <td><span class="badge rounded-pill bg-label-primary me-1"><?= $row->organizer ?></span></td>
                        <td>
                       <a href="<?= base_url('dashboard/events/edit_events/'. $row->event_id);?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                        <a href="<?= base_url('dashboard/events/hapus_events/'. $row->event_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> hapus</a>
                        <tr>  
                          <?php
                          }
                          ?>
